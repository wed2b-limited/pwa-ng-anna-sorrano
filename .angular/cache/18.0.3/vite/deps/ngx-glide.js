...
import {
  ...
  ɵɵtextInterpolate1,
  ɵɵviewQuery
} from "./chunk-5VLB2BKV.js";
import "./chunk-UG3FUIHG.js";
...
function Lazy(Glide2, Components, Events) {
  var settings = Glide2.settings;
  var inView = false;
  var Lazy2 = {
    mount: function mount2() {
    ...
    lazyLoad: function lazyLoad() {
      ...
      inView = true;
      if (Glide2.index + additionSlides < this._slideElements.length) {
        length = Glide2.index + additionSlides;
      } else {
        length = Glide2.index;
      }
...
// node_modules/ngx-glide/fesm2022/ngx-glide.mjs
var _c0 = ["glideEl"];
var _c1 = ["glideSlidesEl"];
var _c2 = ["*"];
...
function NgxGlideComponent_ng_container_16_button_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "button", 14);
  }
  if (rf & 2) {
    const glideBullet_r1 = ctx.$implicit;
    ɵɵattribute("data-glide-dir", "=" + glideBullet_r1);
  }
}
function NgxGlideComponent_ng_container_16_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NgxGlideComponent_ng_container_16_button_1_Template, 1, 1, "button", 13);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngForOf", ctx_r1.glideBullets);
  }
}
var defaultExtraSettings = {
  showArrows: true,
  showBullets: true,
  arrowLeftLabel: "left",
...
var _NgxGlideComponent = class _NgxGlideComponent {
  ...
  ngOnChanges(changes) {
    if (isPlatformBrowser(this.platformId) && changes && this.glide) {
      this.update(_NgxGlideComponent.getGlideUpdateSettings(changes));
    }
  }
  ngAfterViewInit() {
...
_NgxGlideComponent.ɵfac = function NgxGlideComponent_Factory(t) {
  return new (t || _NgxGlideComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PLATFORM_ID));
};
_NgxGlideComponent.ɵcmp = ɵɵdefineComponent({
  type: _NgxGlideComponent,
  selectors: [["ngx-glide"]],
  viewQuery: function NgxGlideComponent_Query(rf, ctx) {
    ...
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.glideEl = _t.first);
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.glideSlidesEl = _t.first);
    }
  },
  inputs: {
  ...
  template: function NgxGlideComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(12, NgxGlideComponent_ng_container_12_Template, 1, 0, "ng-container", 9);
      ɵɵelementEnd();
      ɵɵelementStart(13, "div", 10);
      ɵɵtemplate(14, NgxGlideComponent_ng_container_14_Template, 1, 0, "ng-container", 9);
      ɵɵelementEnd()();
      ɵɵelementStart(15, "div", 11);
      ɵɵtemplate(16, NgxGlideComponent_ng_container_16_Template, 2, 1, "ng-container", 12);
      ɵɵelementEnd()();
    }
    if (rf & 2) {
      ɵɵadvance(6);
      ɵɵstyleProp("display", ctx.showArrows ? "block" : "none");
      ɵɵadvance();
      ɵɵstyleProp("display", ctx.getStyleDisplay(!ctx.arrowLeftTemplate));
      ɵɵadvance();
      ɵɵtextInterpolate1(" ", ctx.arrowLeftLabel, " ");
      ɵɵadvance();
      ɵɵstyleProp("display", ctx.getStyleDisplay(!ctx.arrowRightTemplate));
      ɵɵadvance();
      ɵɵtextInterpolate1(" ", ctx.arrowRightLabel, " ");
      ɵɵadvance();
      ɵɵstyleProp("display", ctx.getStyleDisplay(!!ctx.arrowLeftTemplate));
      ɵɵadvance();
      ɵɵproperty("ngTemplateOutlet", ctx.arrowLeftTemplate);
      ɵɵadvance();
      ɵɵstyleProp("display", ctx.getStyleDisplay(!!ctx.arrowRightTemplate));
      ɵɵadvance();
      ɵɵproperty("ngTemplateOutlet", ctx.arrowRightTemplate);
      ɵɵadvance();
      ɵɵstyleProp("display", ctx.showBullets ? "block" : "none");
      ɵɵadvance();
      ɵɵproperty("ngIf", ctx.glideBullets);
    }
  },
...
var NgxGlideComponent = _NgxGlideComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxGlideComponent, [{
    type: Component,
    args: [{
      standalone: true,
...
var _NgxGlideModule = class _NgxGlideModule {
};
_NgxGlideModule.ɵfac = function NgxGlideModule_Factory(t) {
  return new (t || _NgxGlideModule)();
};
_NgxGlideModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxGlideModule,
  imports: [NgxGlideComponent],
  exports: [NgxGlideComponent]
});
_NgxGlideModule.ɵinj = ɵɵdefineInjector({});
var NgxGlideModule = _NgxGlideModule;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxGlideModule, [{
    type: NgModule,
    args: [{
      imports: [NgxGlideComponent],
      exports: [NgxGlideComponent]
